...
router.get('/bitacora', bitacora_controller_1.default.getInstance().getAllASC);
router.get('/bitacora/descendente', bitacora_controller_1.default.getInstance().getAllDESC);
