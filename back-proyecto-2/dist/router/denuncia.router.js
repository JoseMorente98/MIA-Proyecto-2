...
router.get('/denuncia/:id/:id2', denuncia_controller_1.default.getInstance().getSingle);
...
router.put('/denuncia/bloquear/:id', denuncia_controller_1.default.getInstance().bloquear);
