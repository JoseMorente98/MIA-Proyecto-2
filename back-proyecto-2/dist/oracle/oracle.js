...
var OracleConnection = /** @class */ (function () {
    ...
    OracleConnection.getInstance = function () {
        return this._instance || (this._instance = new this());
    };
    OracleConnection.selectQuery = function (_query, _binds, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, result, _err_1, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.execute(_query)];
                    case 2:
                        result = _a.sent();
                        connection.release();
    ...
    OracleConnection.executeQuery = function (_query, _binds) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, option, binds, result, _err_2, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, 5, 10]);
                    ...
                    case 1:
                        ...
                        binds = _binds || [];
                        return [4 /*yield*/, connection.execute(_query, binds, option)];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result];
